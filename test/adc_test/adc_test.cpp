...
float kp = 0.153882353; // 0.03324
float ki = 0.021098039; // 0.000538
float kd = 0.280470588; // 0.07552;
...
void temp_calculate()
{
    ...
    for (size_t i = 0; i < 64; i++)
    {
        ...
        {
            temp = ((LUT[i + 1][1] - LUT[i - 1][1]) / (LUT[i + 1][0] - LUT[i - 1][0])) * (raw_read - LUT[i + 1][0]) + LUT[i + 1][1];
        }
    }
